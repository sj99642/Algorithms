package test.java.java_algorithms.sort;
...
import main.java.java_algorithms.sort.BubbleSort;
...
public class BubbleSortTest
{
    ...
    {
        assertArrayEquals(BubbleSort.sort(new int[] {1, 3, 2}), new int[] {1, 2, 3});
        assertArrayEquals(BubbleSort.sort(new int[] {4, 3, 2, 1}), new int[] {1, 2, 3, 4});
        assertArrayEquals(BubbleSort.sort(new int[] {1, 0, 0, 1}), new int[] {0, 0, 1, 1});
    }
    ...
    {
        assertArrayEquals(BubbleSort.sort(new int[] {1, 10, 100, 1000}), new int[] {1, 10, 100, 1000});
    }
